...
仿真数据上的 Macro-F1（↑，10 次重复，8:1:1 划分）。10% 离群点 / 标签翻转与 1:10 不平衡仅作用于训练集：

| 场景 | 测试 Macro-F1 | 测试错误率 |
|----------|:------------:|:---------------:|
| 无扰动（clean） | 0.9117 ± 0.0210 | 0.0880 |
| **10% 离群点** | **0.9220 ± 0.0344** | 0.0775 |
| **10% 标签翻转** | **0.8972 ± 0.0186** | 0.1025 |
| **1:10 类别不平衡** | **0.8513 ± 0.0311** | 0.1465 |
| 无扰动，λ = 0（DANAM−） | 0.9117 ± 0.0255 | 0.0880 |

**形状函数恢复**（论文图 2）——在所有扰动设置下，学习曲线均紧贴六个真实分量函数：

<p align="center">
  <img src="codes/codes_DANAM/logs/shape_clean.png" width="720" alt="无扰动仿真数据上的形状函数恢复效果"/>
</p>
